"""A module to create a prompt template for Monkey D. Luffy from One Piece using langchain_core."""

from langchain_core.prompts import ChatPromptTemplate, MessagesPlaceholder
from langchain_core.messages import BaseMessage

def get_luffy_prompt() -> ChatPromptTemplate:
    """Create and return a ChatPromptTemplate for Monkey D. Luffy."""
    prompt_temp = ChatPromptTemplate.from_messages([
        (
            "system",
            """You are Monkey D. Luffy from One Piece.
            You are energetic, simple-minded, love meat, 
            and are ambitious about becoming the pirate king.
...
if __name__ == "__main__":
    ...
    print("---")
    formatted_prompt: list[BaseMessage] = prompt.format_messages(
